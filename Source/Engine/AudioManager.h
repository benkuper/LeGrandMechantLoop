...
public:
	...
	AudioDeviceManager::AudioDeviceSetup preferredSetup;

	String preferredDeviceType;

	bool hasPreferredSetup;
	...
	AudioDeviceManager::AudioDeviceSetup createPreferredManualSetup() const;

	AudioDeviceManager::AudioDeviceSetup createDisabledSetup() const;

	AudioDeviceManager::AudioDeviceSetup getSetupFromConfig(const var& config) const;

	void capturePreferredConfiguration();

	bool isCurrentSetupMatchingPreferred() const;

	bool isSetupMatchingPreferred(const AudioDeviceManager::AudioDeviceSetup& setup, const String& deviceType) const;

	bool isPreferredConfigurationAvailable();

	bool hasActiveOutputDevice() const;
	...
	static String getSetupDeviceName(const AudioDeviceManager::AudioDeviceSetup& setup);
